...
public class Level_2 extends AppCompatActivity {
    ...
    boolean Win = false;
    int score=0;
  //  int count1=1, count2=2, count3=3, count4=4, count5=5, count6=6, count7=7, count8=8, count9=9, count10=10, count11=0, count12=11;
    int count1=0, count2=6, count3=10, count4=8, count5=7, count6=9, count7=3, count8=4, count9=1, count10=5, count11=11, count12=2;
    int image_lc[] = {R.drawable.lc0, R.drawable.lc1, R.drawable.lc2, R.drawable.lc3, R.drawable.lc4, R.drawable.lc5, R.drawable.lc6, R.drawable.lc7, R.drawable.lc8, R.drawable.lc9, R.drawable.lc10, R.drawable.lc11, R.drawable.lc0};
    ...
    public void win() {
        if(count1 == 1 && count2 == 2 && count3 == 3 && count4 == 4 && count5 == 5 && count6 == 6 && count7 == 7 && count8 == 8 && count9 == 9 && count10 == 10 && count11 == 11 && count12 == 0){
            Win = true;
            Intent intent = new Intent(this, YouWin.class);
            intent.putExtra("level", "আপনি দুইটি  লেভেল অতিক্রম করেছেন");
            intent.putExtra("score", ("এবং আপনি মোট " + score + " বার পাজল সরিয়েছেন"));
            intent.putExtra("lebel", "2");
